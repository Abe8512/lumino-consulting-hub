          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
            <div>
              <div className="flex items-center mb-6">
                <span className="text-2xl font-bold text-lumino-800">
                  Lumino<span className="text-lumino-500">Strategies</span>
                </span>
              </div>
              <p className="text-gray-600 mb-6 max-w-xs">
                Transforming business operations through strategic consulting and innovative solutions.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-lumino-600 transition-colors">
        ...
        <FadeIn>
          <div className="border-t border-gray-200 pt-8">
            <p className="text-gray-500 text-center text-sm">
              © {new Date().getFullYear()} Lumino Strategies. All rights reserved.
            </p>
          </div>
        </FadeIn>
      </div>
